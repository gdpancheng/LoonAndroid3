...
public class CustomAdapterActivity extends CommonActivity implements OnClickListener {
	...
	/**
	 * 自动创建了一个以@R.layout.simple_list_item_1布局为item的适配器
	 */
	...
	public void onClick(View arg0) {
		Toast.makeText(CustomAdapterActivity.this, ((Button) arg0).getText(), Toast.LENGTH_SHORT).show();
	}
