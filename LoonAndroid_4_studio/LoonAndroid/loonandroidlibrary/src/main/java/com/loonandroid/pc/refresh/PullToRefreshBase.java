...
import com.loonandroid.pc.refresh.LoadingLayout.DrawFinsh;
...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T> {
	...
	private void init(Context context, AttributeSet attrs) {
		...
		mMode = Mode.mapIntToValue(LoonConstant.pullToRefresh.ptrMode);
		mLoadingAnimationStyle = AnimationStyle.mapIntToValue(LoonConstant.pullToRefresh.ptrAnimationStyle);
		...
		mHeaderLayout.setDrawFinsh(new DrawFinsh() {
			@Override
			public void finsh() {
				if (auto) {
					demo();
		 ...
		 * Styleables from XML
		 */
		if (null != LoonConstant.pullToRefresh.ptrRefreshableViewBackground) {
			mRefreshableView.setBackgroundDrawable(LoonConstant.pullToRefresh.ptrRefreshableViewBackground);
		} else if (null != LoonConstant.pullToRefresh.ptrAdapterViewBackground) {
			Utils.warnDeprecation("ptrAdapterViewBackground", "ptrRefreshableViewBackground");
			mRefreshableView.setBackgroundDrawable(LoonConstant.pullToRefresh.ptrAdapterViewBackground);
		}

		mOverScrollEnabled = LoonConstant.pullToRefresh.ptrOverScroll;
		mScrollingWhileRefreshingEnabled = LoonConstant.pullToRefresh.ptrScrollingWhileRefreshingEnabled;
