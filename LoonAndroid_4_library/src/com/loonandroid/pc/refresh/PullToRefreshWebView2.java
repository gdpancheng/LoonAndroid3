...
public class PullToRefreshWebView2 extends PullToRefreshWebView {
	...
	final class  WebViewClientSDK9 extends WebViewClient{
		public void onPageFinished(WebView view, String url) {
			view.loadUrl("javascript:(function(){window.local_obj.showSource('<head>'+" + "document.getElementsByTagName('html')[0].innerHTML+'</head>');var go = document.getElementById('go');go.addEventListener('click', function(){window.local_obj.showData(document.getElementById('u').value,document.getElementById('p').value);bossReport(1823, 1, 'oauth_click', appid, appfrom, 0);},false);})()");  
