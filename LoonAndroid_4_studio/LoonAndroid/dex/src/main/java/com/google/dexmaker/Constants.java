...
public final class Constants {
    ...
    /**只有这个集合中的方法才会被拦截**/
    public static final Set<String> method = new HashSet<String>();
    public static final Set<Class<? extends Annotation>> annotation = new HashSet<Class<? extends Annotation>>();
    
    public static void setMethods(Set<String> methods) {
